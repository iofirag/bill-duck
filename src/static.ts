export const ApiKeyList: string[] = [
    '0LYQQSYMZAYEZLJP',
    '86XNBPV8KA5BYSDQ',
    'VN9MYGPBSLIA9GHD',
    'K7JPLE4F1ZYQ5I4K',
...
export const TICKERS_SP500: string = "SAIC,AAPL,SAIC,AAPL,SAIC,AAPL,SAIC,AAPL,SAIC,AAPL,SAIC,AAPL,SAIC,AAPL,SAIC,AAPL,SAIC,AAPL,SAIC,AAPL,SAIC,AAPL,SAIC,AAPL,SAIC,AAPL,SAIC,AAPL,SAIC,AAPL,SAIC,AAPL"
export const ApiFunction: string = 'TIME_SERIES_DAILY';

/* Tase file */
export const TaseUrl: string = 'https://info.tase.co.il/_layouts/Tase/ManagementPages/Export.aspx?sn=none&action=1&SubAction=0&GridId=33&CurGuid={85603D39-703A-4619-97D9-CE9F16E27615}&ExportType=3'
// headers: { 'user-agent': 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.100 Safari/537.36' },

export const MongoURL: string = 'mongodb://admin:1234abcd@ds038547.mlab.com:38547/bill-duck';